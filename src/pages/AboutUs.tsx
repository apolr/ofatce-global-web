      ...
      <section className="py-20 bg-muted">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card className="card-hover animate-on-scroll bg-card shadow-lg border-0">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {coreValues.map((value, index) => (
              <Card key={index} className="card-hover animate-on-scroll bg-card shadow-lg border-0">
            ...
            <div className="relative">
              ...
              {timeline.map((item, index) => (
                <div key={index} className="relative flex items-start mb-12 animate-on-scroll">
                  <div className="w-16 h-16 bg-accent rounded-full flex items-center justify-center text-accent-foreground font-poppins font-bold text-lg shadow-lg z-10">
                    {item.year}
                  </div>
